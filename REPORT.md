# 📌 Rättningsrapport – fed25s-the-todos-lisalodin
...
## 🏆 **Betyg: G**
📌 **Motivering:** Projektet uppfyller alla grundkrav och har implementerat fler funktioner som hör till VG-nivån, men saknar manuell sortering av todos.

💡 **Förbättringsförslag:**  
Lägg till funktionalitet för att låta användarna manuellt sortera om todos så att även detta VG-krav uppfylls. Förbättra eventuellt kodstruktur och refaktorisera för ännu bättre kodläslighet.